import { Button } from '@next-cms/ui/button';
...
export default function Page() {
  return (
    <main className={styles.main}>
      ...
      <Button className="bg-blend-darken border-10 text-color-red">Click me!</Button>

      <span className="text-5xl" text="red-900 8xl">
        hello world
      </span>
      <div text="6xl gray"> first2 heloo</div>
      ...
      <div className={styles.grid}>
        {LINKS.map(({ title, href, description }) => (
          <div className={styles.card} key={title} title={title}>
            {description}
          </div>
        ))}
      </div>
